          ...
          <div class="col-md-6">
            <div class="py-2">
              <label for="raamatuNimi" class="inp">
                <input name="Pealkiri" type="text" v-model="raamatuNimi" id="raamatuNimi" placeholder="&nbsp;" required>
                <span class="label">Raamatu nimi</span>
              </label>
            </div>
            <div class="py-2">
              <label for="raamatuKeel" class="inp">
                <select name="Keel" class="form-control" id="raamatuKeel" v-model="raamatuKeel" required>
            ...
            <div class="py-2">
              <label for="textArea" class="inp">
                <textarea name="Kirjeldus" id="textArea" v-model="raamatuKirjeldus" class="txtarea" placeholder="&nbsp;"
                  required></textarea>
          ...
          <div class="col-md-6">
            <div class="py-2">
              <label for="raamatuAutor" class="inp">
                <input name="Autor" v-model="raamatuAutor" id="raamatuAutor" autocomplete="off"
            ...
            <div class="py-2">
              <label for="raamatuKategooria" class="inp">
                <select name="Kategooria" class="form-control" id="raamatuKategooria" v-model="raamatuKategooria" required>
            ...
            <div class="pt-2">
              <input type="file" name="Pilt" accept="image/png, image/jpeg" class="input-file" id="raamatuPilt"
...
const addBook = async () => {
  await uploadImage(raamatuPilt.value.name)
  await client
    .from('RAAMATUD')
...
const uploadImage = async (file) => {
  const { data, error } = await client.storage.from('ABC-Kogu').upload(`/${file}`, raamatuPilt.value)
  if (error) {
    console.error(error)
  } else {
    return data.Key
